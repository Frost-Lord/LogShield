...
const accessLogData = fs.readFileSync('./Train/access.log', 'utf8');
const maliciousLogData = fs.readFileSync('./Train/accessmal.log', 'utf8');
...
async function evaluate() {
    ...
    return `${(evaluation[1].dataSync()[0] * 100).toFixed(2)}%`;
}
